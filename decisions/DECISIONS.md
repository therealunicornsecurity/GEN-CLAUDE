...
## DEC-001 — Adopt EDI workspace conventions
**Date**: YYYY-MM-DD
**Status**: accepted
**Context**: This repo was scaffolded from EDI, which encodes a specific TDD procedure, code review procedure, file structure, and naming convention. Whether the team adopts these as binding is itself a decision.
